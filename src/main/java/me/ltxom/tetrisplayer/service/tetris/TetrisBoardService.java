...
public class TetrisBoardService {
    ...
    public static TetrisBoard analyzeBoardByImage(BufferedImage bufferedImage) {
        ...
        holdX = findTraceResultWithMostConfidence(traceCoordinateInYDirection(bufferedImage,
                holdX, holdY,
    ...
    private static TraceResult findTraceResultWithMostConfidence(ArrayList<TraceResult> list) {
